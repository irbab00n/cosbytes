module.exports = [
   /* ----- REDOKU ----- */
  {
    pictures: [
      ...
      {link: 'https://s3-us-west-1.amazonaws.com/cos-bytes.com/redoku/redoku-progress-5_1920.png', description: 'Full support for those who choose to play mouse-only!'},
    ],
    thumbnails: [
      ...
      {link: 'https://s3-us-west-1.amazonaws.com/cos-bytes.com/redoku/redoku-progress-5_thumb.png'},
    ],
    title: 'redoku',
